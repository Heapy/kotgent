...
/**
 * Base64url against published vectors. The wrapper selects the stdlib URL-safe alphabet and explicitly
 * removes padding, so it is checked against strings produced independently — the RFC 4648 §10 test vectors,
 * and (for the byte values no ASCII vector reaches) values generated by a separate base64url implementation.
 *
